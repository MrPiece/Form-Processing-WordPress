...
function my_register_book()
{
	register_post_type('my_book', [
		'labels' => ['name' => 'Books', 'add_new' => 'New Book', 'add_new_item' => "Add New Book"],
		'rewrite' => ['slug' => 'books'],
		'has_archive' => true,
		'public' => true,
		'show_ui' => true,
		'show_in_menu' => true,
		'supports' => ['title', 'editor', 'author', 'thumbnail', 'post-formats', 'comments', 'excerpt'],
		'menu_icon' => 'dashicons-book',
		'menu_position' => 5
	]);
}

add_action('init', 'my_register_book_taxonomies');
function my_register_book_taxonomies()
{
	...
	register_taxonomy('genre', 'my_book', $args);
	...
	register_taxonomy('writer', 'my_book', $args);
	...
	register_taxonomy('publisher', 'my_book', $args);
}
...
{
	register_sidebar( [
		'name'          => sprintf(__('Sidebar %s'), 'Created By Me' ),
		'id'            => "sidebar-my",
		'description'   => '',
		'class'         => '',
		'before_title'  => '<h2 class="widget-title subheading heading-size-3">',
